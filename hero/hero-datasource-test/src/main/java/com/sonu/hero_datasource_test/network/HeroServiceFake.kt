...
import com.sonu.hero_datasource.network.HeroServiceImpl
import com.sonu.hero_datasource_test.network.data.HeroDataEmpty
import com.sonu.hero_datasource_test.network.data.HeroDataMalformed
...
class HeroServiceFake {
    companion object Factory {
        ...
        fun build(type: HeroServiceResponseType) : HeroService {
